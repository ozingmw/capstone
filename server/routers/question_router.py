...
@router.post("/read")
def read_question(read_question_input: ReadQuestionInput, db: Session = Depends(get_db)) -> ReadQuestionOutput:
    res = question.read_question(read_question_input=read_question_input, db=db)
